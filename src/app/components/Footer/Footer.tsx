        ...
        >
          ...
          <motion.div variants={itemVariants}>
            ...
            <motion.div className="space-y-6" variants={containerVariants}>
              {[
                { icon: 'M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z', text: 'Reichenhainer Straße 37, 09126 Chemnitz, Germany', color: 'text-blue-400' },
                { icon: 'M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z\nM18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z', text: 'muhammad-ibtisam.tanveer@s2024.tu-chemnitz.de', color: 'text-green-400' },
